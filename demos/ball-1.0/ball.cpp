...
int main()
{
	...
	unsigned int sizeSceneX = 21;
	unsigned int sizeSceneY = 21;
	unsigned int scaleScene = 20;
	unsigned int ballRadius = 0;
	...
	window.create(sf::VideoMode(sizeDisplayX, sizeDisplayY), "Simple Cortex - Ball Demo 1.0", sf::Style::Default);
	...
	Area area;
	area.init(cs, cp, numNeurons, {1, 1});
